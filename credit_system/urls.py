...
from api.views import RegisterView, CheckEligibilityView, CreateLoanView, ViewLoanView, ViewLoansByCustomerView
...
urlpatterns = [
    ...
    path('view-loans/<int:customer_id>/', ViewLoansByCustomerView.as_view(), name='view_loans'),
]